...
3. After you have logged in to the [My NeSI Portal](https://my.nesi.org.nz), if you don't see the 'Reset Password' button and instead see error messages, it means your information on our database does not match your Tuakiri identity, your user account has not yet been created, or you are not a member of an active project. In any of these cases, please email [support@nesi.org.nz](mailto:support@nesi.org.nz) and wait for us to confirm your account and add you to an appropriate project group. This is currently a manual step that we aim to complete for every user within two business days of receiving your account request.
